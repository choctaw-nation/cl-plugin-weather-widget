<?php
/**
 * Notifier class for sending notifications to the admin when there is an error with the weather data.
 *
 * @package ChoctawNation
 * @subpackage WeatherWidget
 */

namespace ChoctawNation\WeatherWidget\WP;
...
class Notifier {
	...
	public function send_notification( string $message ) {
		foreach ( $this->emails as $email ) {
			wp_mail( $email, 'Weather Widget Error', $message );
		}
	}
}
